    ...
    return (
      <div>
        ...
        <ul className="hoglist">
          <BabyHog eyeColor={this.state.eyeColor} name="Self Esteem" hobby="Command/slashing tests" />
          <BabyHog eyeColor={this.state.eyeColor} name="Spare Me the Details" hobby="Ping pong" />
          <BabyHog eyeColor={this.state.eyeColor} name="Come Out and Play" hobby="drinking" />
        </ul>
